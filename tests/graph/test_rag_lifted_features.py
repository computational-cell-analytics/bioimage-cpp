...
def test_lifted_edges_discovered_via_diagonal_offset(
    ...
    lifted = bic.graph.features.lifted_edges_from_affinities(
...
def test_lifted_edges_3d():
    ...
    lifted = bic.graph.features.lifted_edges_from_affinities(rag, labels, [(2, 0, 2)])
    np.testing.assert_array_equal(lifted, np.array([[0, 3]], dtype=np.uint64))
...
def test_lifted_edges_threads(four_quadrant_labels_2d, four_quadrant_rag_2d):
    lifted_single = bic.graph.features.lifted_edges_from_affinities(
        four_quadrant_rag_2d,
        four_quadrant_labels_2d,
        [(2, 2), (2, -2)],
        number_of_threads=1,
    )
    lifted_multi = bic.graph.features.lifted_edges_from_affinities(
        four_quadrant_rag_2d,
        four_quadrant_labels_2d,
        [(2, 2), (2, -2)],
        number_of_threads=4,
...
def test_lifted_affinity_features_basic(
    ...
    features = bic.graph.features.lifted_affinity_features(
...
def test_lifted_affinity_features_complex_columns(
    ...
    features = bic.graph.features.lifted_affinity_features_complex(
        four_quadrant_labels_2d, affinities, [(2, 2)], lifted_uvs
    )
...
def test_lifted_affinity_features_threads(
    ...
    single = bic.graph.features.lifted_affinity_features(
        four_quadrant_labels_2d, affinities, [(2, 2)], lifted_uvs,
        number_of_threads=1,
    )
    multi = bic.graph.features.lifted_affinity_features(
        four_quadrant_labels_2d, affinities, [(2, 2)], lifted_uvs,
        number_of_threads=4,
    )
...
def test_lifted_affinity_features_3d():
    ...
    lifted_uvs = bic.graph.features.lifted_edges_from_affinities(rag, labels, [(2, 0, 2)])
    features = bic.graph.features.lifted_affinity_features(
...
def test_lifted_affinity_features_validation():
    ...
    with pytest.raises(ValueError, match="channel count"):
        bic.graph.features.lifted_affinity_features(
...
def test_lifted_edges_validation(four_quadrant_labels_2d, four_quadrant_rag_2d):
    with pytest.raises(ValueError, match="ndim"):
        bic.graph.features.lifted_edges_from_affinities(
